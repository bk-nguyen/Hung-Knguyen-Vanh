...
\usepackage{amsmath, amssymb, tikz, listings}
\usetikzlibrary{arrows.meta, positioning, shadows, chains}
...
% TikZ Styles
\tikzset{
    node_base/.style={circle, draw, minimum size=8mm, font=\bfseries, thick, fill=white, drop shadow},
    node_current/.style={fill=orange!80, text=white}, 
    node_visited/.style={fill=green!40},              
    stack_box/.style={rectangle, draw, minimum width=1.5cm, minimum height=0.6cm, fill=blue!10, font=\small}
}

\title[\text{DFS \& BFS}]{Thuật Toán Duyệt Đồ Thị Chi Tiết}
\subtitle{Mô phỏng trực quan và Mã nguồn minh họa}
\author[Việt Hưng]{Trình bày: \textbf{Việt Hưng}}
\institute[Graph Theory]{Khoa Công nghệ Thông tin}
\date{\today}
...
% Slide 3: Stack
\begin{frame}{1. Ngăn xếp (Stack) - Cơ chế cho DFS}
    \begin{columns}
...
\begin{frame}
    \centering
    \Huge \textcolor{blue}{Cảm ơn các bạn đã lắng nghe!}
    \vspace{1cm}
    \large Chúc các bạn làm chủ được thuật toán đồ thị!
\end{frame}
